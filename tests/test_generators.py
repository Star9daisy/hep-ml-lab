...
def test_Madgraph5():
    ...
    assert generator1.runs[0].cross_section == 6222.1179999999995
    assert generator2.commands == expected2
    assert generator2.runs[0].cross_section == 0.0008714212999999999
    ...
    assert run.cross_section == 0.0008714212999999999
